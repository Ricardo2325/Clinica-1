                ...
                {success ? (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-white/30 text-xs font-body">o</span>
                      <span className="flex-1 h-px bg-white/10" />
                    </div>

                    <button
                      type="button"
                      onClick={() => window.open('https://calendly.com/ricardorodriguezdelgado6', '_blank', 'width=660,height=700')}
                      className="w-full flex items-center justify-center gap-2.5 border border-gold/30 text-gold hover:bg-gold/5 py-3 text-sm font-body font-medium transition-colors duration-300"
                    >
                      ...
                      Reservar primera visita en Calendly
                    </button>
                  </motion.form>
                )}
              </AnimatePresence>
